    ...
    <main className=" text-white  flex-1 mt-[60px] font-playfair ">
      <div className="absolute right-[50%] translate-x-[50%]">
        ...
        <Link href={"/kosik"}>
          ...
          <Link href={cartItems?.length !== 0 && cartItems  ? "/kosik/form" : "/nakupovat"}>
          <div className="w-[110px] flex flex-col justify-center items-center gap-2 max-[660px]:w-[90px]">
          ...
          <Link href={cartItems?.length !== 0 && cartItems && localStorage.getItem("name") ? "/kosik/podtverzeni" : "/nakupovat"}>
          <div className="w-[110px] flex flex-col justify-center items-center gap-2 max-[660px]:w-[90px]">
            <div className="w-[43px] h-[43px] bg-gray-900 text-[35px] flex justify-center items-center max-[660px]:w-[34px] max-[660px]:h-[34px] max-[660px]:text-[28px]">
              3
            </div>
      ...
      {continueOrder ? (
        <div className="flex justify-between  w-[1350px] max-[1350px]:w-[1130px]  m-auto mt-[160px]  max-[1180px]:flex-col max-[1180px]:w-[660px] max-[1180px]:gap-12 max-[660px]:w-[380px] ">
          ...
          <section className="text-end flex flex-col gap-[10px] max-[660px]:gap-[6px]">
            <h2 className="text-[44px] max-[660px]:text-[30px]">
              <b>
                Celkem: {fullPrice && fullPrice.toString().substring(0, 6)}kč
              </b>
            </h2>
